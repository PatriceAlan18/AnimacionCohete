...
public class ScanLine17 extends JFrame implements java.awt.event.MouseListener{
	...
	public static void main(String[] args) {
		ScanLine17 ventana = new ScanLine17();
		...
		ventana.dibujarLinea(150,160,200,100,1,NEGRO);
	...
	public void pintar(int x, int y, Color c, Color fondo) {
		...
		dibujarLinea(inicioX,inicioY,finX,finY,1,fondo);
	...
	public void mouseClicked(MouseEvent e) {
		...
		//System.out.print(fondo.toString());
